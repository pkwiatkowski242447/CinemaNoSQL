...
public class MovieRowTest {
    ...
    public void init() {
        ...
        movieRowNo1 = new MovieRow(movieIdNo1, movieTitleNo1, movieActiveStatusNo1, movieBasePriceNo1, screeningRoomIdNo1);
    }
    ...
    public void movieDocAllArgsConstructorAndGettersTestPositive() {
        MovieRow newMovieRow = new MovieRow(movieIdNo1, movieTitleNo1, movieActiveStatusNo1, movieBasePriceNo1, screeningRoomIdNo1);
