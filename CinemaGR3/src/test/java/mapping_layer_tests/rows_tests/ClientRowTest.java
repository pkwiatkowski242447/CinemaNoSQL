...
public class ClientRowTest {
    ...
    public void init() {
        ...
        clientRowNo1 = new ClientRow(uuidNo1, statusActiveNo1, nameNo1, surnameNo1, ageNo1);
        clientRowNo2 = new ClientRow(uuidNo2, statusActiveNo2, nameNo2, surnameNo2, ageNo2);
    }
    ...
    public void clientDocAllArgsConstructorAndGettersTestPositive() {
        ClientRow testClientRow = new ClientRow(uuidNo1, statusActiveNo1, nameNo1, surnameNo1, ageNo1);
