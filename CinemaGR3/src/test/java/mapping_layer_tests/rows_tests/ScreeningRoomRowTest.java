...
public class ScreeningRoomRowTest {
    ...
    public void init() {
        ...
        screeningRoomRow = new ScreeningRoomRow(screeningRoomId, screeningRoomActiveStatus, screeningRoomFloor, screeningRoomNumber, numberOfAvailableSeats);
    }
    ...
    public void screeningRoomDocAllArgsAndGettersTestPositive() {
        ScreeningRoomRow testScreeningRoomRow = new ScreeningRoomRow(screeningRoomId, screeningRoomActiveStatus, screeningRoomFloor, screeningRoomNumber, numberOfAvailableSeats);
        assertNotNull(testScreeningRoomRow);
