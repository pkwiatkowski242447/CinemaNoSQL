...
@BsonDiscriminator(key = TicketConstants.TICKET_DISCRIMINATOR, value = TicketConstants.NORMAL_TICKET)
public class Normal extends Ticket {
    ...
    @BsonCreator
    public Normal(@BsonProperty(TicketConstants.DOCUMENT_ID) UUID ticketID,
